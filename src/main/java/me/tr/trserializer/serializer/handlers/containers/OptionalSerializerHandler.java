...
public class OptionalHandler implements SerializerHandler {
    public static final OptionalHandler INSTANCE = new OptionalHandler();
    ...
    public DeserializerHandler getDeserializerHandler() {
        return me.tr.trserializer.deserializer.handlers.containers.OptionalHandler.INSTANCE;
    }
}
